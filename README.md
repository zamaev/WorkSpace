...
подсвечены. Тумблеры: «Архив» (архивные проекты), «Без дат» (скрыть
задачи без дат — родитель с датированными потомками остаётся). Вложенные
задачи сворачиваются шевроном; ширина колонки названий тянется за правый
край шапки.
