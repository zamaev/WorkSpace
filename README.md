...
и подзадачи со снятыми галочками). Перенос двигает только ближайшее
вхождение — серия продолжается по своему расписанию (без дублей, даже
если перенёс на день следующего вхождения); поменять само расписание —
в чипе повтора. Будущие вхождения видны полупрозрачными
